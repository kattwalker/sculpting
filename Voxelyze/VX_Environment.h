...
public:
	...
	bool IsPipeEnabled(void) {return PipeEnabled;}
	bool IsIceEnabled(void) {return IceEnabled;}
    ...
    float GetDisintegrationUpdatesPerTempCycle(void) {return DisintegrationUpdatesPerTempCycle;}
    int GetNumDisintegrationUpdates(void) {return NumDisintegrationUpdates;}

    float GetDisintegrationFromPressureThreshold(void) {return DisintegrationFromPressureThreshold;}
    float GetDisintegrationFromStressThreshold(void) {return DisintegrationFromStressThreshold;}
	...
	float GetGreedyStiffnessUpdatesPerTempCycle(void) {return GreedyStiffnessUpdatesPerTempCycle;}
	double getGreedyStiffnessSpeedLimit(){ return GreedyStiffnessSpeedLimit; }
	bool getUsingGreedyStiffnessGrowth(){return GreedyStiffness;}
	double getGreedyStiffnessThreshold(){return GreedyStiffnessThreshold;}

	double GetMinElasticMod() {return MinElasticMod;}
	double GetMaxElasticMod() {return MaxElasticMod;}
	double GetMaxStiffnessVariation() {return MAX_STIFFNESS_VARIATION_STEP;}
	double GetMaxAdaptationRate() {return MaxAdaptationRate;}
	...
	double getRegenerationModelTimeConstant(){return RegenerationModelTimeConstant;}

	float GetStiffnessModelUpdatesPerTempCycle(void) {return StiffnessModelUpdatesPerTempCycle;}
	int getNumHiddenStiffnessNeurons(){return NumHiddenStiffnessNeurons;}
	bool getUsingStiffnessModelInputBias(){return StiffnessModelInputBias;}
	double getStiffnessModelTimeConstant(){return StiffnessModelTimeConstant;}
	...
	float Getbumpsize(){ return bump_size;}
	float GetPipe(){ return pipe;}
	float Getbumpseperation(){return bump_seperation;}
...
private:
	...
	float DisintegrationUpdatesPerTempCycle;
	int NumDisintegrationUpdates;

	float DisintegrationFromPressureThreshold;
	float DisintegrationFromStressThreshold;
	...
	float GreedyStiffnessUpdatesPerTempCycle;
	float GreedyStiffnessSpeedLimit;
	bool GreedyStiffness;
	float GreedyStiffnessThreshold;
	...
	float StiffnessModelUpdatesPerTempCycle;
	int NumHiddenStiffnessNeurons;
	bool StiffnessModelInputBias;
	double StiffnessModelTimeConstant;

	double RegenerationModelTimeConstant;
