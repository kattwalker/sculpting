...
public:
	...
	int GetInternalBondIndex(int dir) {return InternalBondIndices[dir];}
    void RemoveInternalBondIndex(int dir) {InternalBondIndices[dir] = NO_BOND;}
    void NullifyInternalBondPointer(int dir) {InternalBondPointers[dir] = NULL;}
