...
public:
	...
	inline void SetFinalPhaseOffset(int Index, double Value) {pFinalPhaseOffsets[Index] = Value;}
	...
	// DisintegrationOrder functions
	inline void SetDisintegrationOrder(int Index, double Value) {pDisintegrationOrder[Index] = Value;}
	inline double GetDisintegrationOrder(int Index) const {return pDisintegrationOrder[Index];}
	inline void InitDisintegrationOrderArray(int Size) {pDisintegrationOrder = new double[Size];}
	inline bool GetUsingDisintegration(void) {return usingDisintegration;}

	// Insulation functions
	inline void SetInsulation(int Index, double Value) {pInsulation[Index] = Value;}
	inline double GetInsulation(int Index) const {return pInsulation[Index];}
	inline void InitInsulationArray(int Size) {pInsulation = new double[Size];}
	inline bool GetUsingInsulation(void) {return usingInsulation;}

	// ComputationalBoundary functions
	inline void SetComputationalBoundary(int Index, double Value) {pComputationalBoundary[Index] = Value;}
	inline double GetComputationalBoundary(int Index) const {return pComputationalBoundary[Index];}
	inline void InitComputationalBoundaryArray(int Size) {pComputationalBoundary = new double[Size];}
	inline bool GetUsingComputationalBoundary(void) {return usingComputationalBoundary;}
	...
	inline void SetStiffnessModelSynapseWeight(int VoxelIndex, int StiffnessModelSynapseIndex, double Value) {pStiffnessModelSynapseWeights[VoxelIndex][StiffnessModelSynapseIndex] = Value;} // nac: sets the material index here
	inline double GetStiffnessModelSynapseWeight(int VoxelIndex, int StiffnessModelSynapseIndex) const {return pStiffnessModelSynapseWeights[VoxelIndex][StiffnessModelSynapseIndex];}
	inline int GetNumStiffnessModelSynapses() const {return numStiffnessModelSynapses;}

	inline double GetDeprecatedMinElasticMod(void){return DeprecatedMinElasticMod;}
	inline double GetDeprecatedMaxElasticMod(void){return DeprecatedMaxElasticMod;}
...
protected:
	...
	double pStiffnessModelSynapseWeights[1000][20];
	...
	bool usingDisintegration;
	double* pDisintegrationOrder;

	bool usingInsulation;
	double* pInsulation;

	bool usingComputationalBoundary;
	double* pComputationalBoundary;
	...
	double DeprecatedMinElasticMod;
	double DeprecatedMaxElasticMod;
...
public:
	...
	inline void SetStiffnessModelSynapseWeight(int VoxelIndex, int StiffnessModelSynapseIndex, double Value) {Structure.SetStiffnessModelSynapseWeight(VoxelIndex, StiffnessModelSynapseIndex, Value);} // nac: sets the material index here
	inline double GetStiffnessModelSynapseWeight(int VoxelIndex, int StiffnessModelSynapseIndex) const {return Structure.GetStiffnessModelSynapseWeight(VoxelIndex, StiffnessModelSynapseIndex);}
	inline int GetNumStiffnessModelSynapses() const {return Structure.GetNumStiffnessModelSynapses();}
	...
	// DisintegrationOrder functions
	inline void SetDisintegrationOrder(int Index, double Value) { Structure.SetDisintegrationOrder(Index, Value);}
	inline double GetDisintegrationOrder(int Index) const {return Structure.GetDisintegrationOrder(Index);}
	inline void InitDisintegrationOrderArray(int Size) { Structure.InitDisintegrationOrderArray(Size); }
	inline bool GetUsingDisintegration(void) {return Structure.GetUsingDisintegration(); }

	// Insulation functions
	inline void SetInsulation(int Index, double Value) { Structure.SetInsulation(Index, Value);}
	inline double GetInsulation(int Index) const {return Structure.GetInsulation(Index);}
	inline void InitInsulationArray(int Size) { Structure.InitInsulationArray(Size); }
	inline bool GetUsingInsulation(void) {return Structure.GetUsingInsulation(); }

	// ComputationalBoundary functions
	inline void SetComputationalBoundary(int Index, double Value) { Structure.SetComputationalBoundary(Index, Value);}
	inline double GetComputationalBoundary(int Index) const {return Structure.GetComputationalBoundary(Index);}
	inline void InitComputationalBoundaryArray(int Size) { Structure.InitComputationalBoundaryArray(Size); }
	inline bool GetUsingComputationalBoundary(void) {return Structure.GetUsingComputationalBoundary(); }
	...
	inline double GetDeprecatedMinElasticMod(void){return Structure.GetDeprecatedMinElasticMod();}
	inline double GetDeprecatedMaxElasticMod(void){return Structure.GetDeprecatedMaxElasticMod();}
